...
from .modbus import CanHub, async_modbus_setup
...
def get_hub(hass: HomeAssistant, name: str) -> CanHub:
    """Return modbus hub with name."""
    return cast(CanHub, hass.data[DOMAIN][name])
